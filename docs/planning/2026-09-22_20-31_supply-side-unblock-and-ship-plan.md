...
_Plan artifact, not a status snapshot: TODO_LIST.md remains the living source; this file is the execution order. After execution starts, update progress in TODO_LIST (docs-health) and re-plan only if the WP-01 decision invalidates the critical path._
